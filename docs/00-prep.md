...
ただし、**公開したものを1時間以上残したい場合は無料アカウントが必要**です。当日その場でも作れますが、時間を節約したい人は [dash.cloudflare.com](https://dash.cloudflare.com) から先に無料登録しておいてください（クレジットカード不要）。

> 会社のドメインをCloudflareで管理している方は、**業務用アカウントではなく個人アカウントを作ってください。** 当日の公開先を業務環境に混ぜないためです。
