...
> **開発工程はほかにもSkillとして切り出せます。** たとえば「実装したコードに秘密情報の直書きがないか点検する」というSecurity Review Skillは、後半のハンズオン⑦で実際に作ります。SkillとHooksを組み合わせて、**セキュリティレビューを「AIの判断任せ」から「必ず実行される」に変える**のがそこでの狙いです。
