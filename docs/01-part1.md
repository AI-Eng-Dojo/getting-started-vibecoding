...
> **持ち帰ってAIを入れるときの道筋も、一応ここに置いておきます。** 鍵をリポジトリに書かず、**サーバー側（Cloudflare Workersなど）に預けて、そこ経由で呼ぶ**——これが基本形です。今日の後半11で触るCloudflareが、そのまま置き場所になります。**今日はやりません**が、「無理」ではなく「今日の時間には入らない」だけだと覚えておいてください。
