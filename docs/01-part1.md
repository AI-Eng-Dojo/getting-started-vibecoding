# 前半（3時間）Vibe Codingを体験し、自分の意図をAIに伝える方法へ進む
...
- **前半（3時間）**: Vibe Codingを体験し、MCPで外部サービスともつないでみる。次に「自分が本当に作りたいもの」を言葉にする。その言葉にする作法自体を、Grill Me SkillというかたちでAIに覚えさせる
