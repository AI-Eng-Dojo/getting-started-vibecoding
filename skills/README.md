...
前半のハンズオン③・④（[docs/01-part1.md](../docs/01-part1.md)）で作るエージェントスキルの**完成形**です。作るのは2つ、「詰めて」（Grill Me系）と「セキュリティレビュー」です。
...
1つ目より短く、1枚で完結しています。**2つ目は数分で作れる**——それを体感するのが前半5の目的です。このスキルは後半のハンズオン⑧（レビュー・改善）でそのまま実戦投入します。
